...
// довідники (FK) і колір гілки кожної таблиці на графі структури.
...
var tablesMeta = []TableMeta{
	{Name: "positions", Label: "Посади", PK: "position_id", LabelCol: "name", Color: "#0d9488", Columns: []ColumnMeta{
		{Name: "name", Label: "Назва посади", Type: "text", Required: true},
	}},
	{Name: "shifts", Label: "Зміни", PK: "shift_id", LabelCol: "label", Color: "#0891b2", Columns: []ColumnMeta{
	...
	{Name: "employees", Label: "Працівники", PK: "employee_id", LabelCol: "full_name", Color: "#16a34a", Columns: []ColumnMeta{
	...
	{Name: "employee_shifts", Label: "Графік змін", PK: "id", LabelCol: "id", Color: "#22c55e", Columns: []ColumnMeta{
	...
	{Name: "equipment", Label: "Техніка", PK: "equipment_id", LabelCol: "name", Color: "#2563eb", Columns: []ColumnMeta{
	...
	{Name: "equipment_checks", Label: "Перевірки техніки", PK: "check_id", LabelCol: "check_id", Color: "#6366f1", Columns: []ColumnMeta{
	...
	{Name: "fire_types", Label: "Типи пожеж", PK: "fire_type_id", LabelCol: "name", Color: "#9333ea", Columns: []ColumnMeta{
		{Name: "name", Label: "Назва", Type: "text", Required: true},
		{Name: "risk_level", Label: "Рівень ризику", Type: "select", Options: []string{"низький", "середній", "високий"}},
	}},
	{Name: "calls", Label: "Виклики", PK: "call_id", LabelCol: "address", Color: "#dc2626", Columns: []ColumnMeta{
	...
	{Name: "dispatches", Label: "Виїзди", PK: "dispatch_id", LabelCol: "dispatch_id", Color: "#ea580c", Columns: []ColumnMeta{
	...
	{Name: "dispatch_crew", Label: "Екіпажі виїздів", PK: "id", LabelCol: "id", Color: "#f59e0b", Columns: []ColumnMeta{
		{Name: "dispatch_id", Label: "Виїзд №", Type: "ref", Ref: "dispatches", RefLabel: "dispatch_id", Required: true},
		{Name: "employee_id", Label: "Працівник", Type: "ref", Ref: "employees", RefLabel: "full_name", Required: true},
		{Name: "role", Label: "Роль", Type: "text"},
	}},
	{Name: "dispatch_equipment", Label: "Техніка на виїздах", PK: "id", LabelCol: "id", Color: "#eab308", Columns: []ColumnMeta{
		{Name: "dispatch_id", Label: "Виїзд №", Type: "ref", Ref: "dispatches", RefLabel: "dispatch_id", Required: true},
		{Name: "equipment_id", Label: "Техніка", Type: "ref", Ref: "equipment", RefLabel: "name", Required: true},
	}},
	{Name: "damages", Label: "Збитки", PK: "damage_id", LabelCol: "damage_id", Color: "#db2777", Columns: []ColumnMeta{
		{Name: "call_id", Label: "Виклик (адреса)", Type: "ref", Ref: "calls", RefLabel: "address", Required: true},
		{Name: "description", Label: "Опис", Type: "text"},
